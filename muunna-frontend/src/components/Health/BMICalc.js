...
const BMICalc = () => {
    ...
    return (
        <div>
            ...
            <p>
                Syötä laskuriin pituutesi ja painosi. Laskuri näyttää painoindeksin, painoluokan ja miten suuri riski sinulla on sairastua vakavasti painon vuouksi.
            </p>
            ...
            <table className="table">
                <thead className="thead-light">
                    <tr>
                        <th scope="col">Painoindeksi kategoria</th>
                ...
                <tbody>
                    ...
                    <tr className={values.bmi > 25 && values.bmi < 30 ? "table-active" : void 0}>
                        <td>Ylipaino</td>
                        <td>25 - 29.9</td>
